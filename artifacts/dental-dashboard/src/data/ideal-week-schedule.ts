...
export const categoryColors: Record<string, { bg: string; text: string; border: string }> = {
  ...
  startup: { bg: "bg-[#9cc5cc]", text: "text-slate-900", border: "border-[#7fb0b8]" },
  shutdown: { bg: "bg-[#9cc5cc]", text: "text-slate-900", border: "border-[#7fb0b8]" },
  executive: { bg: "bg-violet-500", text: "text-black", border: "border-violet-600" },
  ...
  deepwork: { bg: "bg-blue-400", text: "text-black", border: "border-blue-500" },
