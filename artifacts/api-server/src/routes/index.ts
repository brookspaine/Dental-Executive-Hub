...
import quarterlyReviewRouter from "./quarterlyReview";
import monthlyReviewRouter from "./monthlyReview";
...
router.use(quarterlyReviewRouter);
router.use(monthlyReviewRouter);
