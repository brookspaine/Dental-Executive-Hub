...
- **My Roles**: Role index grouped by Business Area and Tier. Role Detail pages include Purpose & Cultural Alignment, What Success Looks Like (KPIs), Daily Operations Protocol (checklists), Decisions to Own, and Playbooks & Procedures. Features a three-mode toggle: Reference (read-only), Daily (interactive checklists), and Edit (single-buffer form).
