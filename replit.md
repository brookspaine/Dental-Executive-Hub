...
A focused dental practice CEO dashboard with two surfaces: **Today** (daily planning + ideal-week scheduling) and **EDGE** (lease tracking across every EDGE and Urgent Dental location). The earlier modules — Action Items, Team / Org Chart / Roles, Meetings (Leadership + 1-on-1s), and the Playbook Library — were removed in May 2026 to keep the app lean.
